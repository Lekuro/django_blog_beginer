...
urlpatterns = [
    path('hello/', hello),
    path('blogposts/', blogposts_list, name='blogposts_list_endpoint'),
    ...
    path('blogpost/<str:slug>/delete/', BlogPostDeleteView.as_view(),
         name='blogpost_delete_endpoint'),
    ...
    path('tag/<str:slug>/delete/', TagDeleteView.as_view(),
         name='tag_delete_endpoint'),
]
